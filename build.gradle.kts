...
val rmcArtifact = "blood-magic-guard"
val rmcVersion = "1.0.0"
val rmcBaseName = "Blood-Magic-Guard"
...
dependencies {
    ...
    add("compileClasspath", "dependencies:bloodmagic:1.16.5")
    add("compileClasspath", "rmc.libs:event-factory:1.0.0")
